...
export const routes: Routes = [
    ...
    {
        path: 'audio-list',
        loadComponent: () => import('./pages/audio-list.component').then(m => m.AudioListComponent),
    },
    {
        path: 'summary-list',
        loadComponent: () => import('./pages/summary-list.component').then(m => m.SummaryListComponent),
    },
    {
        path: 'settings',
